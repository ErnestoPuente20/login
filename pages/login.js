...
const Login = () => (
    <section className="form-login">
        ...
        <Input className="entrada" placeholder="Nombre" size="large"/>
        <Input className="entrada" placeholder="Apellido" size="large"/>
        <Input className="entrada" placeholder="Edad" size="large"/>
